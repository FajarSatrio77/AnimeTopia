...
import {
  ...
  /**
   * Public function to update to a specific episode number from UI selection
   * 
   * @param {number|string} episodeNumber - The episode number to switch to
   * @param {HTMLInputElement} episodeInput - The input element for the episode
   * @param {HTMLElement} prevButton - Previous episode button
   * @param {HTMLElement} nextButton - Next episode button
   * @param {HTMLElement} currentEpButton - Current episode display button
   * @param {HTMLElement} playerInfo - Player info element
   * @param {HTMLElement} playerContainer - Player container element
   */
  export function updateEpisodeByNumber(
    episodeNumber,
    episodeInput,
    prevButton,
    nextButton,
    ...
    // Call the existing updateEpisode function with the selected episode number
    updateEpisode(
      episodeNumber,
      episodeInput,
      prevButton,
